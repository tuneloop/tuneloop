...
function ctx(session: Session): ProcessorContext {
  return { session, log: noopLog, llmEnabled: false, llm: null, existingFeatures: [], existingTopics: [], rejectedFeatureTitles: [], userLinkedArtifacts: [], prBlockAttributions: [], sh: ghSh }
}
