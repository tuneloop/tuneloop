...
function ctx(s: Session, sh: ProcessorContext['sh']): ProcessorContext {
  return { session: s, log: noopLog, llmEnabled: false, llm: null, existingFeatures: [], existingTopics: [], rejectedFeatureTitles: [], userLinkedArtifacts: [], prBlockAttributions: [], sh }
}
